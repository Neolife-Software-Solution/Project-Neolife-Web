    ...
    <div>
      ...
      <div class="bg-[#645FCE] max-w-full mx-auto p-2 justify-between text-slate-200 flex flex-row fixed top-0 left-0 right-0 items-center">
        ...
        <div class="flex flex-row items-center lg:gap-4">
          ...
          <span class="hidden text-2xl text-black logotext lg:block">NeoLife</span>
        ...
        <div>
          ...
          <div class="flex flex-row items-center gap-5 sm:mr-3 lg:me-5">
            ...
            <a href="#" class="hidden lg:block">
              ...
              <span class="px-4 py-3 font-medium duration-700 ease-out rounded-md headertext hover:bg-indigo-600 hover:ease-in hover:transition hover:duration-300 hover:text-white">Home</span>
            ...
            <a href="#" class="hidden lg:block">
              ...
              <span class="px-4 py-3 font-medium duration-700 ease-out rounded-md headertext hover:bg-indigo-600 hover:ease-in hover:transition hover:duration-300 hover:text-white">Our Services</span>

            </a>

            <a href="#" class="hidden lg:block">

              <span class="px-4 py-3 font-medium duration-700 ease-out rounded-md headertext hover:bg-indigo-600 hover:ease-in hover:transition hover:duration-300 hover:text-white">Our Project</span>

            </a>

            <a href="#" class="hidden lg:block">

              <span class="px-4 py-3 font-medium duration-700 ease-out rounded-md headertext hover:bg-indigo-600 hover:ease-in hover:transition hover:duration-300 hover:text-white">About US</span>

            </a>

            <a href="#" class="hidden lg:block">

              <span class="px-4 py-3 font-medium duration-700 ease-out rounded-md headertext hover:bg-indigo-600 hover:ease-in hover:transition hover:duration-300 hover:text-white">Contact Us</span>
